...
Migration acceptance requires schema validation, parity tests between both manifests, a fresh local installation, and confirmation that plugin identity remains `maya-design`.
