# AGENTS.md — Autodesk Maya Design
...
```bash
node scripts/bump-plugin.mjs maya-design patch   # 文档/注释/小修复
node scripts/bump-plugin.mjs maya-design minor   # 新功能
node scripts/bump-plugin.mjs maya-design major   # 破坏性变更
```
